  ...
  settings: {
    ...
    appearance: {
      ...
      fonts: {
        ...
        uiScale: "UI zoom",
        uiScaleHint: "Scales the whole interface: text, controls, spacing",
        uiScaleAccessibility: "UI zoom",
        iconScale: "Icon size",
        iconScaleHint: "Scales icon glyphs only, independent of UI zoom",
        iconScaleAccessibility: "Icon size",
